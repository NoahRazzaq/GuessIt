    ...
    <div class="mt-4 grid gap-4">
        @foreach ($guesses as $guess)
            ...
            <div class="bg-white shadow-md rounded-lg p-4 border border-gray-200 flex items-start gap-4">
                {{-- Image de l'objet --}}
                <div class="w-16 h-30 flex-shrink-0 overflow-hidden rounded-md border border-gray-200">
                    <img src="{{ Storage::disk('s3')->url($guess->object->image_path) }}" alt="{{ $guess->object->name }}"
                ...
                <div class="flex-1">
                    ...
                    <p class="text-xs mt-1"><strong>Prix deviné :</strong> {{ number_format($guess->guessed_price, 2) }} €
                    </p>
